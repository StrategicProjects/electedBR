...
- **Who was elected?** Candidates elected in municipal (2020, 2024) and
  ...
  Superior Electoral Court ([TSE](https://dadosabertos.tse.jus.br/))
...
- **Who is serving now?** Federal deputies and senators currently in
  ...
  service history of each member.
...
- TSE, *Resultados*:
  <https://dadosabertos.tse.jus.br/dataset/resultados-2024> (and 2018,
  2020, 2022). Yearly files:
