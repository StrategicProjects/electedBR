#!/bin/zsh
# Uploads data-raw/parquet/*.parquet and data-raw/officeholding_events.csv to
# the Hugging Face dataset used by electedBR, then run: Rscript data-raw/elected_years.R
# (the events CSV alone can be re-uploaded any time after editing it).
...
hf upload "$REPO" data-raw/officeholding_events.csv officeholding_events.csv --repo-type dataset
